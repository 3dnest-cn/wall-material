...
export const ParentDoor = {
	...
	render: (graphics, context) => {
		...
		graphics
			...
			.lineTo(height * 3/7 *(1-flipSign), height /2)
			.drawRect(0, height / 2, doorThickness, -width * 3/7* flipSign)
			.drawRect(width, height / 2, -doorThickness, width * 3/7* flipSign - width);
